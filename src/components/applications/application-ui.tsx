...
const stageColors: Record<ApplicationStatus, string> = { new: "bg-slate-100 text-slate-700", shortlisted: "bg-purple-100 text-purple-800", consent_requested: "bg-amber-100 text-amber-800", consent_approved: "bg-emerald-100 text-emerald-800", screening: "bg-blue-100 text-blue-800", assessment: "bg-indigo-100 text-indigo-800", review: "bg-blue-100 text-blue-800 dark:bg-blue-950/60 dark:text-blue-300", interview: "bg-fuchsia-100 text-fuchsia-800", offer: "bg-emerald-100 text-emerald-800", hired: "bg-emerald-200 text-emerald-900", rejected: "bg-red-100 text-red-800", withdrawn: "bg-slate-200 text-slate-700" };
