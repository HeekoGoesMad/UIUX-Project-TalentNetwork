...
export default function ScreeningQueuePage() {
  ...
  return <ProtectedRoute role="recruiter"><main className="container mx-auto max-w-6xl px-4 py-8 sm:py-10">
    <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
       <div><p className="flex items-center gap-2 font-mono text-xs uppercase tracking-widest text-primary"><ClipboardCheck className="size-4" /> Recruiter operations</p><h1 className="mt-3 text-3xl font-bold tracking-tight">Screening queue</h1><p className="mt-2 max-w-2xl text-muted-foreground">Pantau screening otomatis setelah profil kandidat dibuka. Screening bukan keputusan hire atau reject.</p></div>
