...
export const CAREER_STATUS_CONFIG: Record<CareerStatus, { label: string; color: string; dot: string; emoji: string }> = {
  "open-to-work": { label: "Siap Bekerja", color: "bg-slate-50 text-[#7C3AED] border border-slate-200", dot: "bg-[#7C3AED]", emoji: "🟣" },
  "open-for-opportunities": { label: "Terbuka Peluang", color: "bg-[#FEF3C7] text-[#92400E] border border-[#F59E0B]/30", dot: "bg-[#F59E0B]", emoji: "🟡" },
  "freelance-available": { label: "Tersedia Freelance", color: "bg-[#EFF6FF] text-[#1E40AF] border border-[#BFDBFE]", dot: "bg-[#2563EB]", emoji: "🔵" },
  "internship-available": { label: "Tersedia Magang", color: "bg-slate-50 text-[#7C3AED] border border-slate-200", dot: "bg-[#7C3AED]", emoji: "🟣" },
  "not-available": { label: "Tidak Tersedia", color: "bg-slate-100 text-slate-700", dot: "bg-slate-500", emoji: "⚫" },
};
